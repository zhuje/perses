...
//     // JZ TODO: October 24, 2023 -- Gabriel suggests storing the results in an array and then returning it 
//     // to the dataQueriesProvider. 
//     // const results[] 
...
export function useTraceQueries (
    ...
    // JZ NOTES: test only one defintion for now 
    // const definition = definitions[0] as TraceQueryDefinition;
    console.log('JZ traceImpl Definition : ', definitions)
